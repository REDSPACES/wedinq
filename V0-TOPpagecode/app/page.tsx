  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-amber-50 via-rose-50 to-amber-50 flex items-center justify-center overflow-x-hidden">
      ...
      <div className="w-full relative z-10">
        ...
        <div className="min-h-screen flex items-center justify-center">
          ...
          >
            ...
            <div className="mt-16 flex flex-col md:flex-row gap-4 justify-center animate-fade-in-slow animation-delay-800">
              <button
                type="button"
                className="px-8 py-3 bg-amber-900 hover:bg-amber-800 text-white rounded-full font-serif tracking-widest uppercase text-sm transition-all duration-300 hover:shadow-lg hover:scale-105"
              >
                RSVP
              </button>
              <button
                type="button"
                className="px-8 py-3 border-2 border-amber-700 text-amber-900 hover:bg-amber-50 rounded-full font-serif tracking-widest uppercase text-sm transition-all duration-300 hover:shadow-lg hover:scale-105"
              >
                View Details
              </button>
            </div>
        ...
        {/* Section 2: Message */}
        <div ref={messageRef} className="min-h-screen flex items-center justify-center py-12 px-6">
          <div
            className={`max-w-2xl w-full transition-all duration-1000 ${showMessage ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
          >
            ...
            <div className="relative mx-auto" style={{ maxWidth: "500px" }}>
              ...
              <div className="relative z-10 p-8 pt-12">
                ...
                <div className="bg-gray-200 rounded-sm aspect-square mb-8 flex items-center justify-center overflow-hidden relative">
                  <Image
